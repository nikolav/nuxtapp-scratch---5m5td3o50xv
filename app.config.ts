...
export default defineAppConfig({
  ...
  io: {
    ...
    IOEVENT_ASSETS_UPDATED_prefix: "IOEVENT:ASSETS:UPDATED:lwzAwwnpz:",
  },
  theme: {
    DEFAULT: themeLight,
    DARK: themeDark,
  ...
  links: {
    external: {
      ...
      DRIVE_ATTACHMENTS_MAIN:
        "https://drive.google.com/drive/folders/1s7857o4GgGIBFHPb0BjEOFJQUPa-Hctb?usp=drive_link",
    },
  },
  re: {
  ...
  icon: {
    ...
    aliases: {
      ...
      "text-align-justified": "akar-icons:text-align-justified",
      "text-align-right": "akar-icons:text-align-right",
      "text-align-left": "akar-icons:text-align-left",
      "list-bullet": "ooui:list-bullet-ltr",
      "list-ordered": "flowbite:ordered-list-outline",
      "format-size": "material-symbols:format-size",
      "format-heading": "bx:heading",
      "format-underlined": "material-symbols:format-underlined",
      "format-italic": "material-symbols:format-italic",
      "format-bold": "material-symbols:format-bold",
